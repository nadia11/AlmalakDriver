  ...
  checkLogin = async () => {
    ...
    if(this.state.mobileNumber === ""){
      ...
      .then(async (responseJson) => {
        ...
        else if(responseJson.code === 501 && responseJson.profile_status === "incomplete"){
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
          ...
          <ImageBackground source={require('../assets/login-bg.jpeg')} style={{ flex: 4, justifyContent: 'center', alignItems: 'center', resizeMode: 'contain', height: SCREEN_HEIGHT-200, width: SCREEN_WIDTH, marginBottom: 120, paddingTop: 50 }}>
          ...
          <Animatable.View animation="slideInUp" iterationCount={1} useNativeDriver={true} style={{flex:4, paddingBottom: 40, backgroundColor: "#fff" }}>
            <Animated.View style={{ height: this.loginHeight, backgroundColor: 'white' }}>
              <Animated.View style={{ opacity: headerTextOpacity, alignItems: 'flex-start', paddingHorizontal: 25, marginTop: marginTop }}>
                <Text style={{ fontSize: 24, marginVertical: 15 }}>Welcome to Uder Service</Text>
              </Animated.View>
