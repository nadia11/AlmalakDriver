...
function HomeStackScreen() {
  return (
    <HomeStack.Navigator screenOptions={Options.APP_OPTIONS.SCREEN_OPTIONS} headerMode='float'>
  ...
  return (
    <View style={styles.profileCard}>
        <View style={styles.profileImageWrap}>
          {userPhoto !== "" && <Image style={{ height: 50, width: 50, resizeMode: 'contain', borderRadius: 100 }} source={require('../assets/avatar.png')} /> }
