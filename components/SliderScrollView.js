            ...
            <View style={[styles.container, {height: sliderHeight ? sliderHeight : 300}]}>
                ...
                ref={this.scrollRef}>
                    ...
                    {this.props.images.map((image, index) => (
                        this.props.fromUrl ? (
                            <Image key={image} source={{uri: image}} style={{ width: SCREEN_WIDTH, height: sliderHeight, resizeMode: 'cover' }} />
                        ) : (
                            <Image key={image} source={image} style={{ width: SCREEN_WIDTH, height: sliderHeight, resizeMode: 'cover' }} />
                        )
                    ))}
                </Animated.ScrollView>
